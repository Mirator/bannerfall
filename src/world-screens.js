...
import { PERKS, availablePerks, perkPointsEarned, bannerLabel, perkMods } from './progression.js?v=rd93aa08103be';
import { clamp, rrect } from './engine.js?v=rd93aa08103be';
import { SQUAD_LABELS } from './battle/constants.js?v=rd93aa08103be';
import {
  SPECIALIZATIONS, SPEC_IDS, OBJECTIVE_LABELS, STRONGHOLD_POWER_LABELS,
} from './region.js?v=rd93aa08103be';
import { pointInWorldHud, heroPresentationPosition } from './world/visual-style.js?v=rd93aa08103be';
