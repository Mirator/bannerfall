...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp, enemyStrength } from '../data.js?v=r16ad0951ca1b';
import { perkMods, recruitTroop } from '../progression.js?v=r16ad0951ca1b';
import { dist2 } from '../engine.js?v=r16ad0951ca1b';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=r16ad0951ca1b';
