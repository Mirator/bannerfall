...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp, enemyStrength } from '../data.js?v=r6d03cd1c99d9';
import { perkMods, recruitTroop } from '../progression.js?v=r6d03cd1c99d9';
import { dist2 } from '../engine.js?v=r6d03cd1c99d9';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=r6d03cd1c99d9';
