...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp } from '../data.js?v=r040c1e5b1560';
import { perkMods, recruitTroop } from '../progression.js?v=r040c1e5b1560';
import { dist2 } from '../engine.js?v=r040c1e5b1560';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=r040c1e5b1560';
