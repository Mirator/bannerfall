...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp } from '../data.js?v=re622d3d3cf30';
import { perkMods, recruitTroop } from '../progression.js?v=re622d3d3cf30';
import { dist2 } from '../engine.js?v=re622d3d3cf30';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=re622d3d3cf30';
