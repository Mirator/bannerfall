...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp } from '../data.js?v=ra61468519e7e';
import { perkMods, recruitTroop } from '../progression.js?v=ra61468519e7e';
import { dist2 } from '../engine.js?v=ra61468519e7e';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=ra61468519e7e';
