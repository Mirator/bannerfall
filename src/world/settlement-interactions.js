...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp, enemyStrength } from '../data.js?v=rd43c5efe0f57';
import { perkMods, recruitTroop } from '../progression.js?v=rd43c5efe0f57';
import { dist2 } from '../engine.js?v=rd43c5efe0f57';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=rd43c5efe0f57';
