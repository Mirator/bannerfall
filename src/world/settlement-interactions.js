...
import { PAL, WORLD, UNIT_TYPES, BALANCE, armySlots, troopMaxHp, enemyStrength } from '../data.js?v=ra5856137107c';
import { perkMods, recruitTroop } from '../progression.js?v=ra5856137107c';
import { dist2 } from '../engine.js?v=ra5856137107c';
import { REGION, SPECIALIZATIONS, OWNERSHIP, settlementRecord } from '../region.js?v=ra5856137107c';
