...
import { WORLD } from '../data.js?v=ra5856137107c';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=ra5856137107c';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=ra5856137107c';
