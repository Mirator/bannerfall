...
import { WORLD } from '../data.js?v=r3729900262ac';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=r3729900262ac';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=r3729900262ac';
