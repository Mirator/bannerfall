...
import { WORLD } from '../data.js?v=r3b20caaaa2ab';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=r3b20caaaa2ab';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=r3b20caaaa2ab';
