...
import { WORLD } from '../data.js?v=r70b613c6e5cd';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=r70b613c6e5cd';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=r70b613c6e5cd';
