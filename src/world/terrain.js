...
import { WORLD } from '../data.js?v=r1a9e52c1bce3';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=r1a9e52c1bce3';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=r1a9e52c1bce3';
