...
import { WORLD } from '../data.js?v=ra324aad8885b';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=ra324aad8885b';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=ra324aad8885b';
