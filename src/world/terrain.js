...
import { WORLD } from '../data.js?v=rd93aa08103be';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=rd93aa08103be';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=rd93aa08103be';
