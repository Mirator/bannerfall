...
import { WORLD } from '../data.js?v=rf03ab8f72f41';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=rf03ab8f72f41';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=rf03ab8f72f41';
