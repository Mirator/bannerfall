...
import { WORLD } from '../data.js?v=r44f9dbca8fbc';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=r44f9dbca8fbc';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=r44f9dbca8fbc';
