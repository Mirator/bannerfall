...
import { WORLD } from '../data.js?v=ra61468519e7e';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=ra61468519e7e';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=ra61468519e7e';
