...
import { WORLD } from '../data.js?v=rbf9ac38b53d8';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=rbf9ac38b53d8';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=rbf9ac38b53d8';
