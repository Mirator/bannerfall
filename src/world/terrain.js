...
import { WORLD } from '../data.js?v=re622d3d3cf30';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=re622d3d3cf30';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=re622d3d3cf30';
