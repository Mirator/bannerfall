...
import { WORLD } from '../data.js?v=rb7fae751c29c';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=rb7fae751c29c';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=rb7fae751c29c';
