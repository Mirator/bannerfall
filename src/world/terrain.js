...
import { WORLD } from '../data.js?v=r0a1bd3998320';
import { TAU, dist2, distToSegment, makeRng } from '../engine.js?v=r0a1bd3998320';
import { WORLD_ART, worldRegionAt } from './visual-style.js?v=r0a1bd3998320';
