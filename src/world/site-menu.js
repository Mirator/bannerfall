...
import { PAL, UNIT_TYPES, oddsWord, ODDS_WORDS, armySlots } from '../data.js?v=rd93aa08103be';
import { bannerCost, bannerLabel } from '../progression.js?v=rd93aa08103be';
...
import { restAndHeal, expandArmy } from './settlement-interactions.js?v=rd93aa08103be';
