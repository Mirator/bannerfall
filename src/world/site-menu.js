...
import { PAL, UNIT_TYPES, oddsWord, ODDS_WORDS, armySlots } from '../data.js?v=ra9c0449dbe2f';
import { bannerCost, bannerLabel } from '../progression.js?v=ra9c0449dbe2f';
...
import { restAndHeal, expandArmy } from './settlement-interactions.js?v=ra9c0449dbe2f';
