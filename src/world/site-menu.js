...
import { PAL, UNIT_TYPES, oddsWord, ODDS_WORDS, armySlots } from '../data.js?v=re622d3d3cf30';
import { bannerCost, bannerLabel } from '../progression.js?v=re622d3d3cf30';
...
import { restAndHeal, expandArmy } from './settlement-interactions.js?v=re622d3d3cf30';
