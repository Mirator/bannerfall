...
import { PAL, UNIT_TYPES, oddsWord, ODDS_WORDS, armySlots } from '../data.js?v=rf0428fde8b3b';
import { bannerCost, bannerLabel } from '../progression.js?v=rf0428fde8b3b';
...
import { restAndHeal, expandArmy } from './settlement-interactions.js?v=rf0428fde8b3b';
