...
import { PAL, UNIT_TYPES, oddsWord, ODDS_WORDS, armySlots } from '../data.js?v=rfdf6abae5ce0';
import { bannerCost, bannerLabel } from '../progression.js?v=rfdf6abae5ce0';
...
import { restAndHeal, expandArmy } from './settlement-interactions.js?v=rfdf6abae5ce0';
