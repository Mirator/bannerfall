...
import { WORLD, BALANCE, rollComposition } from '../data.js?v=r795695426ca8';
import { dist2, clamp } from '../engine.js?v=r795695426ca8';
import { ACTIONS } from '../input-actions.js?v=r795695426ca8';
import { buildBriefModel, veteranLine } from '../world-screens.js?v=r795695426ca8';
import { sampleBattlefield } from './battlefield-brief.js?v=r795695426ca8';
import { FIELD } from '../battle/constants.js?v=r795695426ca8';
import { encounterObjective, strongholdModifiers } from '../region.js?v=r795695426ca8';
import { awardVeterancy, perkMods } from '../progression.js?v=r795695426ca8';
import { performSiteAction } from './site-menu.js?v=r795695426ca8';
