...
import { PAL, WORLD } from '../data.js?v=r040c1e5b1560';
import { TAU, shadow, shade, tree, mountain, rrect, rock } from '../engine.js?v=r040c1e5b1560';
import {
  hoverTargetAt, drawHoverPanel, isOverHud, drawBriefPanel, drawAftermathPanel,
  drawSpecPanel, drawPerkPanel, drawSitePanel,
} from '../world-screens.js?v=r040c1e5b1560';
import {
...
import { drawParty, drawHero, drawHud } from './render-actors.js?v=r040c1e5b1560';
import { WORLD_ART, worldRegionAt, worldHudLayout } from './visual-style.js?v=r040c1e5b1560';
