...
import { PAL, WORLD } from '../data.js?v=r719ffab26c0f';
import { TAU, shadow, shade, tree, mountain, rrect, rock } from '../engine.js?v=r719ffab26c0f';
import {
  hoverTargetAt, drawHoverPanel, isOverHud, drawBriefPanel, drawAftermathPanel,
  drawSpecPanel, drawPerkPanel, drawSitePanel,
} from '../world-screens.js?v=r719ffab26c0f';
import {
...
import { drawParty, drawHero, drawHud } from './render-actors.js?v=r719ffab26c0f';
import { WORLD_ART, worldRegionAt, worldHudLayout } from './visual-style.js?v=r719ffab26c0f';
