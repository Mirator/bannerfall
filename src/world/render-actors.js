...
import { PAL, WORLD, BALANCE, armySlots, rankOf } from '../data.js?v=rf0428fde8b3b';
import { perkMods } from '../progression.js?v=rf0428fde8b3b';
import { TAU, rrect, shadow } from '../engine.js?v=rf0428fde8b3b';
import { strongholdModifiers, STRONGHOLD_POWER_LABELS } from '../region.js?v=rf0428fde8b3b';
import { WORLD_ART, worldHudLayout, heroPresentationPosition } from './visual-style.js?v=rf0428fde8b3b';
import { nearestSite, siteChipLabel } from './site-menu.js?v=rf0428fde8b3b';
