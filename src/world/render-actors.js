...
import { PAL, WORLD, BALANCE, armySlots, rankOf } from '../data.js?v=ra61468519e7e';
import { perkMods } from '../progression.js?v=ra61468519e7e';
import { TAU, rrect, shadow } from '../engine.js?v=ra61468519e7e';
import { strongholdModifiers, STRONGHOLD_POWER_LABELS } from '../region.js?v=ra61468519e7e';
import { WORLD_ART, worldHudLayout, heroPresentationPosition } from './visual-style.js?v=ra61468519e7e';
import { nearestSite, siteChipLabel } from './site-menu.js?v=ra61468519e7e';
