...
import { PAL, WORLD, BALANCE, armySlots, rankOf } from '../data.js?v=r68c3ea5d32ff';
import { perkMods } from '../progression.js?v=r68c3ea5d32ff';
import { TAU, rrect, shadow } from '../engine.js?v=r68c3ea5d32ff';
import { strongholdModifiers, STRONGHOLD_POWER_LABELS } from '../region.js?v=r68c3ea5d32ff';
import { WORLD_ART, worldHudLayout, heroPresentationPosition } from './visual-style.js?v=r68c3ea5d32ff';
import { nearestSite, siteChipLabel } from './site-menu.js?v=r68c3ea5d32ff';
