...
import { PAL, WORLD, BALANCE, armySlots, rankOf } from '../data.js?v=ra5856137107c';
import { perkMods } from '../progression.js?v=ra5856137107c';
import { TAU, rrect, shadow } from '../engine.js?v=ra5856137107c';
import { strongholdModifiers, STRONGHOLD_POWER_LABELS } from '../region.js?v=ra5856137107c';
import { WORLD_ART, worldHudLayout, heroPresentationPosition } from './visual-style.js?v=ra5856137107c';
import { nearestSite, siteChipLabel } from './site-menu.js?v=ra5856137107c';
