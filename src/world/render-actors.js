...
import { PAL, WORLD, BALANCE, armySlots, rankOf } from '../data.js?v=r88a307371bf1';
import { perkMods } from '../progression.js?v=r88a307371bf1';
import { TAU, rrect, shadow } from '../engine.js?v=r88a307371bf1';
import { strongholdModifiers, STRONGHOLD_POWER_LABELS } from '../region.js?v=r88a307371bf1';
import { WORLD_ART, worldHudLayout, heroPresentationPosition } from './visual-style.js?v=r88a307371bf1';
import { nearestSite, siteChipLabel } from './site-menu.js?v=r88a307371bf1';
