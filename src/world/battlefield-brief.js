...
import { WORLD } from '../data.js?v=r47a9e4eb3305';
import { makeRng, deriveSeed, RNG_DOMAINS } from '../engine.js?v=r47a9e4eb3305';
import { ENGAGE_GAP } from '../battle/constants.js?v=r47a9e4eb3305';
