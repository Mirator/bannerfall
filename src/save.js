...
import { WORLD, UNIT_TYPES, ENEMY_TYPES, HERO, BALANCE } from './data.js?v=r44f9dbca8fbc';
import { SPECIALIZATIONS, isValidSpec, OWNERSHIP } from './region.js?v=r44f9dbca8fbc';
