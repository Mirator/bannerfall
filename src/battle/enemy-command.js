...
import { clamp, dist2, makeRng, deriveSeed, RNG_DOMAINS } from '../engine.js?v=r16ad0951ca1b';
import {
...
function decide(battle) {
  ...
  if (doctrine !== cmd.doctrine) {
    ...
    // Plan 049: and the field says it too, for a player watching the line rather than the
    // banner — a ring under every enemy while the commitment lands. Presentation reads this;
    // nothing here reads presentation back.
    battle.enemyAlertT = 1.1;
