...
import { HERO } from '../data.js?v=ra5856137107c';
import { clamp, lerp, angLerp, dist2, len } from '../engine.js?v=ra5856137107c';
...
} from './constants.js?v=ra5856137107c';
import { enemyAnchorFor, isIsolated, mustersInLine } from './enemy-command.js?v=ra5856137107c';
