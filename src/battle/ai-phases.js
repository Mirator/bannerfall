...
import { HERO } from '../data.js?v=rf0428fde8b3b';
import { clamp, lerp, angLerp, dist2, len } from '../engine.js?v=rf0428fde8b3b';
...
} from './constants.js?v=rf0428fde8b3b';
import { enemyAnchorFor, isIsolated, mustersInLine } from './enemy-command.js?v=rf0428fde8b3b';
