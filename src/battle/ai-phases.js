...
import { HERO } from '../data.js?v=rbf9ac38b53d8';
import { clamp, lerp, angLerp, dist2, len } from '../engine.js?v=rbf9ac38b53d8';
...
} from './constants.js?v=rbf9ac38b53d8';
import { enemyAnchorFor, isIsolated, mustersInLine } from './enemy-command.js?v=rbf9ac38b53d8';
