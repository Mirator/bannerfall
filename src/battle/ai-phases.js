...
import { HERO } from '../data.js?v=ra324aad8885b';
import { clamp, lerp, angLerp, dist2, len } from '../engine.js?v=ra324aad8885b';
...
} from './constants.js?v=ra324aad8885b';
import { enemyAnchorFor, isIsolated, mustersInLine } from './enemy-command.js?v=ra324aad8885b';
