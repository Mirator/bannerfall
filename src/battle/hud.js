...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=rf0428fde8b3b';
import { TAU, clamp, rrect } from '../engine.js?v=rf0428fde8b3b';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=rf0428fde8b3b';
import { stanceIcon } from './render-units.js?v=rf0428fde8b3b';
