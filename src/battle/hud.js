...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=ra314b0d08bae';
import { TAU, clamp, rrect } from '../engine.js?v=ra314b0d08bae';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=ra314b0d08bae';
import { stanceIcon } from './render-units.js?v=ra314b0d08bae';
