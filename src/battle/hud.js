...
import { HERO, enemyStrength, playerStrength } from '../data.js?v=rd5531dcfef09';
import { clamp, rrect } from '../engine.js?v=rd5531dcfef09';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=rd5531dcfef09';
import { stanceIcon } from './render-units.js?v=rd5531dcfef09';
