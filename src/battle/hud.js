...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=r0a1bd3998320';
import { TAU, clamp, rrect } from '../engine.js?v=r0a1bd3998320';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=r0a1bd3998320';
import { stanceIcon } from './render-units.js?v=r0a1bd3998320';
