...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=r3b20caaaa2ab';
import { TAU, clamp, rrect } from '../engine.js?v=r3b20caaaa2ab';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=r3b20caaaa2ab';
import { stanceIcon } from './render-units.js?v=r3b20caaaa2ab';
