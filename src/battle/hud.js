...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=rd77bf905fb0b';
import { TAU, clamp, rrect } from '../engine.js?v=rd77bf905fb0b';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=rd77bf905fb0b';
import { stanceIcon } from './render-units.js?v=rd77bf905fb0b';
