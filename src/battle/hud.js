...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=ra5856137107c';
import { TAU, clamp, rrect } from '../engine.js?v=ra5856137107c';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=ra5856137107c';
import { stanceIcon } from './render-units.js?v=ra5856137107c';
