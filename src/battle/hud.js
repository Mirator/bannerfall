...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=re622d3d3cf30';
import { TAU, clamp, rrect } from '../engine.js?v=re622d3d3cf30';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=re622d3d3cf30';
import { stanceIcon } from './render-units.js?v=re622d3d3cf30';
