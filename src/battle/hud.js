...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=ra324aad8885b';
import { TAU, clamp, rrect } from '../engine.js?v=ra324aad8885b';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=ra324aad8885b';
import { stanceIcon } from './render-units.js?v=ra324aad8885b';
