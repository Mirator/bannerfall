...
import { HERO, BALANCE, enemyStrength, playerStrength, weightText } from '../data.js?v=rd93aa08103be';
import { TAU, clamp, rrect } from '../engine.js?v=rd93aa08103be';
import { SQUAD_LABELS, STANCE_NOTES } from './constants.js?v=rd93aa08103be';
import { stanceIcon } from './render-units.js?v=rd93aa08103be';
