export const ACTIONS = Object.freeze({
  ...
  CONFIRM: 'confirm', CONTINUE_RUN: 'continueRun', NEW_HARD_RUN: 'newHardRun', PAUSE: 'pause', MUTE: 'mute', ABANDON_RUN: 'abandonRun',
});
...
export const DEFAULT_BINDINGS = Object.freeze({
  ...
  [ACTIONS.CONFIRM]: ['Enter'], [ACTIONS.CONTINUE_RUN]: ['KeyC'], [ACTIONS.NEW_HARD_RUN]: ['KeyH'],
